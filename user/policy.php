...
//MODIFICACION FV
echo '<div class="noticebox" style="height:250px; ">';
echo '<div class="embed-responsive embed-responsive-21by9">
  <iframe class="embed-responsive-item" src="https://virtual.flacso.org.ar/theme/gflacso/vale/moodle/index.html"></iframe>
</div> ';
echo '</div>';

$formcontinue = new single_button(new moodle_url('policy.php', array('agree' => 1)), "SI/SIM/YES");
$formcancel = new single_button(new moodle_url($CFG->wwwroot.'/login/logout.php', array('agree' => 0)), "NO/NÃO");
