 ...
 */
(function() {
    tinymce.create('tinymce.plugins.MoodleGFlacsoSeparator', {
        ...
        init : function(ed, url) {
            ...
            ed.addCommand('mceMoodleGFlacsoSeparator', function() {
                lang = ed.getParam('language');
                ed.windowManager.open({
                    file : ed.getParam("moodle_plugin_base") + 'gflacsoseparator/dialog.php?lang=' + lang ,
                    width : 350,
                    height : 120,
                    inline : 1
                }, {
            ...
            ed.addButton('gflacsoseparator', {
                title : 'gflacsoseparator.desc',
                cmd : 'mceMoodleGFlacsoSeparator',
                image : url + '/img/insert_gflacsoseparator.png'
            });
        },
        ...
        getInfo : function() {
            return {
                longname : 'Moodle GFlacso Separator plugin',
    ...
    // Register plugin.
    tinymce.PluginManager.add('gflacsoseparator', tinymce.plugins.MoodleGFlacsoSeparator);
})();
