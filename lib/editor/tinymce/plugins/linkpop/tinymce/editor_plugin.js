 ...
 */
(function() {
    tinymce.create('tinymce.plugins.MoodleLinkpop', {
        ...
        init : function(ed, url) {
            ...
            ed.addCommand('mceMoodleLinkpop', function() {
                lang = ed.getParam('language');
                ed.windowManager.open({
                    file : ed.getParam("moodle_plugin_base") + 'linkpop/dialog.php?lang=' + lang ,
                    width : 350,
                    height : 120,
                    inline : 1
                }, {
            ...
            ed.addButton('linkpop', {
                title : 'linkpop.desc',
                cmd : 'mceMoodleLinkpop',
                image : url + '/img/insert_linkpop.png'
            });
        },
        ...
        getInfo : function() {
            return {
                longname : 'Moodle Linkpop plugin',
    ...
    // Register plugin.
    tinymce.PluginManager.add('linkpop', tinymce.plugins.MoodleLinkpop);
})();
