M.block_accessibility = {
	...
	*/
	...
	init: function(Y, autoload_atbar, instance_id) {
		...
		Y.all('#block_accessibility_textresize button').on('click', function(e) {
		...
		Y.all('#block_accessibility_changecolour button').on('click', function(e) {
			if (!e.target.hasClass('disabled')) {
		...
		Y.all('#accessibility_controls button').each(function(node){
