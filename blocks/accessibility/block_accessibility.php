...
class block_accessibility extends block_base {
    ...
    public function get_content() {
        ...
        $c1attrs = array(
                ...
                'aria-label' => 'Esquema de colores por Defecto',
                'tabindex' => '0'
        );
        $c2attrs = array(
                ...
                'aria-label' => 'Contraste disminuído 1',
                'tabindex' => '0'
        );
        $c3attrs = array(
                ...
                'aria-label' => 'Contraste disminuído 2',
                'tabindex' => '0'
        );
        $c4attrs = array(
        ...
        $content .= html_writer::tag('button', $strchar . '-', $decattrs);
        $content .= html_writer::end_tag('li');

        $content .= html_writer::start_tag('li', array('class' => 'access-button'));
        $content .= html_writer::tag('button', $strchar, $resetattrs);
        $content .= html_writer::end_tag('li');

        $content .= html_writer::start_tag('li', array('class' => 'access-button'));
        $content .= html_writer::tag('button', $strchar . '+', $incattrs);
        $content .= html_writer::end_tag('li');

        $content .= html_writer::start_tag('li', array('class' => 'access-button'));
        $content .= html_writer::tag('button', '&nbsp', $saveattrs);
        $content .= html_writer::end_tag('li');
        ...
        $content .= html_writer::start_tag('li', array('class' => 'access-button'));
        $content .= html_writer::tag('button', $resetchar, $c1attrs);
        $content .= html_writer::end_tag('li');

        $content .= html_writer::start_tag('li', array('class' => 'access-button'));
        $content .= html_writer::tag('button', $strchar, $c2attrs);
        $content .= html_writer::end_tag('li');

        $content .= html_writer::start_tag('li', array('class' => 'access-button'));
        $content .= html_writer::tag('button', $strchar, $c3attrs);
        $content .= html_writer::end_tag('li');

        $content .= html_writer::start_tag('li', array('class' => 'access-button'));
        $content .= html_writer::tag('button', $strchar, $c4attrs);
        $content .= html_writer::end_tag('li');
