...
//Render linkpops for print agregado FV
echo "
<script> 
...
window.onload = function() {
  var linkpops = document.getElementsByClassName('linkpop');
  for (i = 0; i < linkpops.length; i++) {
    var ref = document.createElement('i');
    ref.innerHTML = ' (Ref: '+linkpops[i].title+')';
    insertAfter(ref,linkpops[i]);
  }
};
