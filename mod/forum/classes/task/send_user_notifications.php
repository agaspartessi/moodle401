...
class send_user_notifications extends \core\task\adhoc_task {
    ...
    protected function send_post($course, $forum, $discussion, $post, $cm, $context) {
        ...
        // FV: Para que no mande mails a profesores que son de otros grupos

        if ($discussion->groupid > 0) {
            if (!groups_is_member($discussion->groupid) and has_capability('moodle/course:managegroups', $context)) {
