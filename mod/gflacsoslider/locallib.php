...
require_once("$CFG->dirroot/mod/gflacsoslider/lib.php");



function gflacsoslider_get_editor_options($context = null) {
    global $CFG;
 ...
 */
class gflacsoslider_content_file_info extends file_info_stored {
