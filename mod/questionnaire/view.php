...
//se agrega strip_tags para sacar los tags de titulo de Encuesta FV Gaspar Tessi
$questionnaire->page->add_to_page('questionnairename', strip_tags(format_string($questionnaire->name)));
